        ...
        <div className="col-md-6">
          <div className="card mb-4">
            ...
            <div className="card-body">
              ...
              <div className="mt-3">
                <p>
                  <strong>Cookie 分析:</strong>
                </p>
                <ul className="list-unstyled">
                  <li>
                    ACCESS_TOKEN:{' '}
                    {cookies.includes('ACCESS_TOKEN') ? '✅ 存在' : '❌ 不存在'}
                  </li>
                  <li>
                    LINE_LOGIN:{' '}
                    {cookies.includes('LINE_LOGIN') ? '✅ 存在' : '❌ 不存在'}
                  </li>
                  <li>
                    總 Cookie 數量:{' '}
          ...
          <div className="card">
            ...
            <div className="card-body">
              ...
              <div className="mt-3">
                ...
                <ul>
                  <li>
                    <strong>測試登入:</strong> 使用測試帳號進行登入測試
                  </li>
                  <li>
                    <strong>測試認證檢查:</strong> 檢查當前認證狀態
                  </li>
                  <li>
                    <strong>刷新 Cookie:</strong> 重新讀取瀏覽器 Cookie
                  </li>
                </ul>
              </div>
            </div>
        ...
        <div className="col-12">
          <div className="card">
            ...
            <div className="card-body">
              ...
              <ol>
                <li>
                  <strong>Cookie 無法設置:</strong> 檢查 secure
                  設定，開發環境應為 false
                </li>
                <li>
                  <strong>認證狀態不更新:</strong> 檢查 useAuth hook 的狀態管理
                </li>
                <li>
                  <strong>跳轉失敗:</strong> 檢查 router.replace 是否正確調用
                </li>
                <li>
                  <strong>API 路徑錯誤:</strong> 確認 API 路由是否正確設置
                </li>
              </ol>
